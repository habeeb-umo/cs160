...
public class GameEngine{
    ...
    private void moveTerriers() {
        ...
        for (Terrier d : dogs) {
            ...
            if (field[currentRow][currentCol] == 'D')
                System.out.print("Terrier[" + dogs.indexOf(d) + "] moved into Terrier at ");
            else if (field[currentRow][currentCol] == 'F')
                System.out.print("Terrier[" + dogs.indexOf(d) + "] moved into Fence at ");
            else if (field[currentRow][currentCol] == 'T')
                System.out.print("Terrier[" + dogs.indexOf(d) + "] moved into Tree at");
            else if (field[currentRow][currentCol] == 'S')
                System.out.print("Terrier[" + dogs.indexOf(d) + "] ate Squirrel at ");
            else if (currentRow < 0)
                System.out.print("Terrier[" + dogs.indexOf(d) + "] exited the top at ");
            else if (currentRow >= field.length)
                System.out.print("Terrier[" + dogs.indexOf(d) + "] exited the bottom at ");
            else if (currentCol < 0)
                System.out.print("Terrier[" + dogs.indexOf(d) + "] exited the left at ");
            else if (currentCol >= field[0].length)
                System.out.print("Terrier[" + dogs.indexOf(d) + "] exited the right at ");
            else
