...
public class R2 {
	...
	public static void main(String[] args) {
		...
		System.out.println((b0 + b1) / 4); // Only returns an integer
		System.out.println((b0 + b1) / 4.0); // Returns a double at the sight of a decimal
		System.out.println(s0 / 1000);
		System.out.println(s0 / 1000.0);
		System.out.println(s1 % 100); // Modulo -- Returns the remainder
		System.out.println((i0 - 2345) * 10); // Order of Operators (Modulo = Multiplication)
		System.out.println(i0 - 2345 * 10);
		System.out.println(l0 + l1);
		System.out.println((f0 + f1) / (d0 * d1));
		System.out.println(0.1 + 0.2 - 0.3); // The factors are floating point values
